...
@section('title', 'Car Selling Project')
...
<section class="ftco-section ftco-no-pt bg-light">
    				...
    				<div class="carousel-car owl-carousel">
    					...
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
    							<div class="img rounded d-flex align-items-end" style="background-image: url({{Storage::url($rs->image)}});width:290px;height:220px;"></div>
    							<div class="text">
	...
	<div class="col-md-12">
		<div class="carousel-car owl-carousel">
			...
			<div class="item">
				<div class="car-wrap rounded ftco-animate">
					<div class="img rounded d-flex align-items-end justify-content-center align-items-center"  style="background-image: url({{Storage::url($rs->image)}});width:420px;height:380px;"></div>
					<div class="text">  								
						<div class="d-flex mb-3">    									
						</div>
						</div>
