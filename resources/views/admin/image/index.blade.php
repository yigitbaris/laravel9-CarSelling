...
<h2>{{$cars->title}}</h2>
<form role="form" action="{{route('admin.image.store',['cid'=>$cars->id])}}" method="post" enctype="multipart/form-data">
	@csrf
				...
				<table class="table table-striped" style="background-color: white;">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="{{route('admin.category.destroy',['id'=>$rs->id])}}" class="btn btn-danger" onclick="return confirm('Deleting {{$rs->title}}!! Are you sure?')">Delete </a></td>
						</tr>
